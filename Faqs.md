...
- Who can contribute?
  - Anyone with a github account who is signed up for
[hacktoberfest](https://hacktoberfest.digitalocean.com/) :)
- Are you getting paid for this?
  - Sadly no. But we think we should be paid. This is 100% unofficial and we do it for fun, fame and glory.
...
- Should I come close to the text that says 'Don't come closer' on the left side of the home tab?
  - Nope.
- How many pull requests (PR) must be made if I want to get an awesome tshirt from Hacktoberfest 2023?
  - 4
